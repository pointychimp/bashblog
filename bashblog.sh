...
Generated with <a href="https://bitbucket.org/pointychimp/bashblog">bashblog2</a>, based on <a href="https://github.com/cfenollosa/bashblog">bashblog</a></div>' > "$global_footerFile"
    fi
}
